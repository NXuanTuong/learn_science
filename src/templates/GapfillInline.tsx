      ...
      <div className="flex flex-col gap-8 justify-center items-center w-full">
        {questionTexts && questionTexts.length > 0 && (
          <div className="flex flex-row flex-wrap gap-4 p-4 bg-gradient-to-r from-green-200 to-blue-200 rounded-xl shadow-lg justify-center items-center">
            {questionTexts.map((text: any, index: number) => (
              <Fragment key={index}>
                {/* Text phần cố định */}
                <span className="text-xl font-semibold text-green-900 select-none">
                  {text}
                </span>

                {/* Nếu chưa đến cuối, thêm input */}
